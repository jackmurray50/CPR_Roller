...
namespace CPR_Roller
{
    public class InteractionHandler
    {
        ...
        public Dictionary<string,Character> _cachedCharacters;
        ...
        public InteractionHandler(DiscordSocketClient client, InteractionService handler, IServiceProvider services, IConfiguration config)
        {
            ...
            _cachedCharacters = new Dictionary<string, Character>();
        }
        ...
        private async Task ReadyAsync()
        {
            ...
            if (Program.IsDebug())
                await _handler.RegisterCommandsToGuildAsync(367678847061327876, true);
            else
